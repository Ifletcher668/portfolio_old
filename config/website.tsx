...
export default {
    ...
    metaDescriptions: {
        homepage:
            'Isiah Fletcher is a drummer, poet, and software engineer in Boise, Idaho. He play for Aterrima, an extreme metal band, publishes poetry on his website, and is a freelance web developer.',
        portfolio:
            "A Software Engineer's key feature is the ability to work from anywhere. Isiah lives in Boise, Idaho, and works remotely. He builds GatsbyJS websites that specialize in sleek, fast front-end designs and slim serverless back-ends. He deploys to AWS and Netlify, and architects MongoDB and MySQL databases.",
        writingPage:
            'Isiah is a poet and content writer. He earned a B.A. in Creative Writing from the University of Idaho.',
        poetryPage:
            'The role of poetry, Isiah believes, is to teach himself and others (mostly himself) how and why they are alive. His poetry reflects his deepest passions: philosophy, nature, futurism and software. He has written poems since he was 20, and earned a B.A. in Creative Writing from the University of Idaho.',
